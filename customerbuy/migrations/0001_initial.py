...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='productcustomerbuy',
            name='tag_product',
            field=models.ForeignKey(to='customerbuy.TagProductCustomerBuy'),
        ),
        migrations.AddField(
            model_name='contactcustomerbuy',
            name='customer_provider',
            field=models.ForeignKey(to='customerbuy.CustomerBuy'),
        ),
        migrations.AddField(
            model_name='addresscustomerbuy',
            name='customer_buy',
            field=models.ForeignKey(to='customerbuy.CustomerBuy'),
        ),
    ]
